        ...
        <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
          ...
          >
            <div class="px-6 py-2 border-b border-light-grey">
              <div class="font-bold text-xl">List Tenda</div>
            </div>
            <div class="px-6 py-2 border-b border-light-grey">
              {{-- search bar --}}
              <div class="pt-2 relative mx-auto text-gray-600">
                <form action="/cari" method="get">
                    <input placeholder="Cari Pegawai .." type="search" name="search" placeholder="Search" class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none">
