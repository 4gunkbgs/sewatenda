      ...
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <form class="w-3/4">                                   
            ...
            @if ($errors->has('jenisbarang'))
                <p class="text-red-500 text-xs italic">{{ $errors->first('jenisbarang') }}</p>
            @endif                            
            
            <input required wire:model="namabarang" type="text" placeholder="Perahu, Tali" class="appearance-none block w-full bg-white text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white">            
