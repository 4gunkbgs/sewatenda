                ...
                <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                    ...
                    <div class="pt-2 relative mx-auto text-gray-600">
                            <div class="flex justify-between">
                                ...
                                <div>                                   
                                    <button wire:click="showModal()" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Tambah Data
